// <copyright file="OfferController.cs" company="mission-one">
...
namespace Comabit.UI.Seller.Controllers
{
    ...
    public class OfferController : BaseController
    {
        ...
        public OfferController(FileManager fileManager, MatchManager matchManager, InquiryManager inquiryManager, ILogger<OfferController> logger) : base(logger)
        {
        ...
        {
            ICollection<MatchViewModel> Matches = this.Mapper.Map<ICollection<MatchViewModel>>(await this._matchManager.GetSellerMatches(User.GetCompanyId(), new List<MatchState>() { MatchState.offered, MatchState.accepted, MatchState.ordered, MatchState.renew }));
