...
namespace Comabit.DL.Migrations
{
    ...
    [Migration("20210914143355_removeAreainCategories2")]
    partial class removeAreainCategories2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Comabit.DL.Data.Portfolio.PortfolioAreaCategory", b =>
                {
                    ...
                    b.ToTable("PortfolioAreasCategories");
                });
            ...
            modelBuilder.Entity("PortfolioAreaCategorySellerCompany", b =>
                {
                    b.Property<Guid>("PortfolioAreaCategoriesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("SellerCompaniesId")
                        .HasColumnType("uuid");

                    b.HasKey("PortfolioAreaCategoriesId", "SellerCompaniesId");
            ...
            modelBuilder.Entity("PortfolioAreaSubCategorySellerCompany", b =>
                {
                    b.Property<Guid>("PortfolioAreaSubCategoriesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("SellerCompaniesId")
                        .HasColumnType("uuid");

                    b.HasKey("PortfolioAreaSubCategoriesId", "SellerCompaniesId");
            ...
            modelBuilder.Entity("PortfolioAreaCategorySellerCompany", b =>
                {
                    b.HasOne("Comabit.DL.Data.Portfolio.PortfolioAreaCategory", null)
                        .WithMany()
                        .HasForeignKey("PortfolioAreaCategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PortfolioAreaSubCategorySellerCompany", b =>
                {
                    b.HasOne("Comabit.DL.Data.Portfolio.PortfolioAreaSubCategory", null)
                        .WithMany()
                        .HasForeignKey("PortfolioAreaSubCategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
