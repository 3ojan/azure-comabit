...
namespace Comabit.DL.Migrations
{
    ...
    [Migration("20210929065348_Create-Match-Offer-Message-File")]
    partial class CreateMatchOfferMessageFile
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuyerInquiryPortfolioCategory", b =>
                {
                    b.Property<Guid>("BuyerInquireId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("PortfolioCategoriesId")
                        .HasColumnType("uuid");

                    b.HasKey("BuyerInquireId", "PortfolioCategoriesId");

                    b.HasIndex("PortfolioCategoriesId");

                    b.ToTable("BuyerInquiryPortfolioCategory");
                });

            modelBuilder.Entity("BuyerInquiryPortfolioSubCategory", b =>
                {
                    b.Property<Guid>("BuyerInquireId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("BuyerInquireId", "PortfolioSubCategoriesId");

                    b.HasIndex("PortfolioSubCategoriesId");

                    b.ToTable("BuyerInquiryPortfolioSubCategory");
                });
            ...
            modelBuilder.Entity("Comabit.DL.Data.Inquiry.BuyerInquiry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Comabit.DL.Data.Inquiry.BuyerProjectInquiryFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BuyerProjectInquiryFile");
                });

            modelBuilder.Entity("Comabit.DL.Data.Inquiry.BuyerProjectInquiryFileData", b =>
                {
                    b.Property<Guid>("BuyerProjectInquiryFileId")
                        .HasColumnType("uuid");

                    b.Property<byte[]>("FileData")
                        .HasColumnType("bytea");

                    b.HasKey("BuyerProjectInquiryFileId");

                    b.ToTable("BuyerProjectInquiryFileData");
                });

            modelBuilder.Entity("Comabit.DL.Data.Inquiry.File", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Comabit.DL.Data.Inquiry.FileData", b =>
                {
            ...
            modelBuilder.Entity("Comabit.DL.Data.Inquiry.OfferFile", b =>
                {
                    b.HasBaseType("Comabit.DL.Data.Inquiry.File");
            ...
            modelBuilder.Entity("BuyerInquiryPortfolioCategory", b =>
                {
                    b.HasOne("Comabit.DL.Data.Inquiry.BuyerInquiry", null)
                        .WithMany()
                        .HasForeignKey("BuyerInquireId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Comabit.DL.Data.Inquiry.BuyerProjectInquiryFile", b =>
                {
                    b.HasOne("Comabit.DL.Data.Inquiry.BuyerProjectInquiry", "BuyerProjectInquiry")
                        .WithMany("BuyerProjectInquiryFiles")
            ...
            modelBuilder.Entity("Comabit.DL.Data.Inquiry.BuyerProjectInquiryFileData", b =>
                {
                    b.HasOne("Comabit.DL.Data.Inquiry.BuyerProjectInquiryFile", "BuyerProjectInquiryFile")
                        .WithOne("BuyerProjectInquiryFileData")
                        .HasForeignKey("Comabit.DL.Data.Inquiry.BuyerProjectInquiryFileData", "BuyerProjectInquiryFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BuyerProjectInquiryFile");
                });

            modelBuilder.Entity("Comabit.DL.Data.Inquiry.FileData", b =>
                {
                    b.HasOne("Comabit.DL.Data.Inquiry.File", "File")
                        .WithOne("FileData")
                        .HasForeignKey("Comabit.DL.Data.Inquiry.FileData", "FileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Comabit.DL.Data.Match.Match", b =>
                {
                    b.HasOne("Comabit.DL.Data.Inquiry.BuyerInquiry", "Inquiry")
                        .WithMany("Matchs")
            ...
            modelBuilder.Entity("Comabit.DL.Data.Match.Offer", b =>
                {
                    b.HasOne("Comabit.DL.Data.Inquiry.OfferFile", "File")
                        .WithOne("Offer")
            ...
            modelBuilder.Entity("Comabit.DL.Data.Inquiry.BuyerProjectInquiry", b =>
                {
                    b.Navigation("BuyerProjectInquiryFiles");
                });

            modelBuilder.Entity("Comabit.DL.Data.Inquiry.BuyerProjectInquiryFile", b =>
                {
                    b.Navigation("BuyerProjectInquiryFileData");
                });
